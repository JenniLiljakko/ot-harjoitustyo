...
class TestMaksukortti(unittest.TestCase):
    ...
    def test_syo_edullisesti_onnistuu_kun_kortilla_on_edullisen_lounaan_verran_saldoa(self):
        self.kortti.syo_edullisesti()
        self.kortti.syo_edullisesti()
        self.kortti.syo_edullisesti()
        self.kortti.syo_edullisesti()
    ...
    def test_syo_maukkaasti_onnistuu_kun_kortilla_on_maukkaan_lounaan_verran_saldoa(self):
